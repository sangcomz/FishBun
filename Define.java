package com.trams.blindring.define;
 ...
 */
public class Define {
    public static int IMAGE_PADDDING_TOP = 0;
    public static int IMAGE_PADDDING_LEFT = 0;
    public static int IMAGE_PADDDING_BOTTOM = 0;
    public static int IMAGE_PADDDING_RIGHT = 0;
    public static int ALBUM_THUMNAIL_WIDTH = -1;
    public static int ALBUM_THUMNAIL_HEIGHT = 0;
    ...
    public static String ACTIONBAR_TEXT="";
